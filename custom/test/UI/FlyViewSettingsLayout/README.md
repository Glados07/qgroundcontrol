...
`custom/custom.qrc` resource with PySide6 (Qt 6). The test checks 320/480/800/1200
pixel content areas, 150% fonts, dark/light palettes, and produces screenshots.
...
palette, file dialogs and text-field chrome are test doubles; this is not a full
