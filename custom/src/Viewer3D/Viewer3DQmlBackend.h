...
private:
    bool _externalMapSourceEnabled() const;
    bool _trySetExternalMapGpsRef();
    void _restoreBestGpsRef();
    QGeoCoordinate _externalMapOrigin() const;
...
protected slots:
    ...
    void _externalMapSettingsChanged(QVariant value);
};
